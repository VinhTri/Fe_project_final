...
const translations = {
  vi: {
    ...
    "budgets.tab.healthy": "Đang ổn",
    "budgets.tab.warning": "Sắp đạt ngưỡng",
    "budgets.tab.over": "Đã vượt",
    ...
    "budgets.banner.over_count": "{count} hạn mức đã vượt. ",
    "budgets.banner.warning_count": "{count} hạn mức sắp đạt ngưỡng.",
    "budgets.banner.view_warnings": "Xem cảnh báo",
    "budgets.banner.view_over": "Xem đã vượt",
    ...
    "budgets.status.healthy": "Đang ổn",
    "budgets.status.warning": "Sắp đạt",
    "budgets.status.over": "Đã vượt",
  ...
  en: {
    ...
    "budgets.status.warning": "Approaching",
